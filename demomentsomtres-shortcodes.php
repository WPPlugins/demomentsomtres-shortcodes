 ...
 * Description: Skeleton themes inspired shortcodes.<br/>Provides the following ones [one_half], [one_third], [two_thirds], [one_fourth], [three_fourths], [one_fifth], [two_fifth], [three_fifth], [four_fifth], [one_sixth], [five_sixth].
 * Version: 1.0
 * Author: Marc Queralt
...
function dmst_shortcodes_init() {
    if (!is_admin()):
        wp_enqueue_style('dmst-shortcodes', plugins_url('demomentsomtres-shortcodes.css', __FILE__), array(), '201303', 'all');
    endif;
}

add_action('init', 'dmst_shortcodes_init');
...
// Latest Posts
// DeMomentSomTres - supressio Latest Posts per evitar thumbs.php - inici
...
// DeMomentSomTres - supressio Latest Posts per evitar thumbs.php - final
